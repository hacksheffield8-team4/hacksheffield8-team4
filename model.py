...
df['home_renewableFraction'] = (1 if hasExcessPower else(df['solar_energy_for_15m'] + (((df['load_power_kW'] - (df['pv_totalPower_kW'] * newNumberOfPanels / df['NumberOfPanels'])) / 4)) * df['grid_renewableFraction_pct']) / df['load_power_kW'] / 4)
